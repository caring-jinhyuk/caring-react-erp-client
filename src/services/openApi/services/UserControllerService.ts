...
export class UserControllerService {
	...
	public static saveUserUsingPost(
		...
		return __request(OpenAPI, {
			...
			query: {
				...
				'user.provider.insuranceState.dependents[0].date':
					userProviderInsuranceStateDependents0Date,
				'user.provider.insuranceState.dependents[0].idNumber':
					userProviderInsuranceStateDependents0IdNumber,
				'user.provider.insuranceState.dependents[0].name':
					userProviderInsuranceStateDependents0Name,
				'user.provider.insuranceState.dependents[0].nation':
					userProviderInsuranceStateDependents0Nation,
				'user.provider.insuranceState.dependents[0].permission':
					userProviderInsuranceStateDependents0Permission,
				'user.provider.insuranceState.dependents[0].permissionEndAt':
					userProviderInsuranceStateDependents0PermissionEndAt,
				'user.provider.insuranceState.dependents[0].permissionStartAt':
					userProviderInsuranceStateDependents0PermissionStartAt,
				'user.provider.insuranceState.dependents[0].relation':
				...
				'user.provider.workCenter.address.addressDetail':
	 ...
	 * @throws ApiError
	 */
	public static getCurrentUserUsingGet(
		userCenterId?: number,
		userEmail?: string,
		userId?: number,
		userName?: string,
	 ...
	 * @throws ApiError
	 */
	public static getCenterUserListUsingPost(
		userCenterId?: number,
		userEmail?: string,
		userId?: number,
		userName?: string,
