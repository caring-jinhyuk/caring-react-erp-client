...
export class CaregiverControllerService {
	 ...
	 * @throws ApiError
	 */
	public static saveCaregiverUsingPost(caregiver: Caregiver): CancelablePromise<Caregiver> {
		return __request(OpenAPI, {
			method: 'POST',
			url: '/caregiver',
			body: caregiver,
	 ...
	 * @throws ApiError
	 */
	public static getCityCountUsingGet(city: string): CancelablePromise<number> {
		return __request(OpenAPI, {
			method: 'GET',
	 ...
	 * @throws ApiError
	 */
	public static updateCaregiverUsingPut(id: number): CancelablePromise<Caregiver> {
		return __request(OpenAPI, {
			method: 'PUT',
