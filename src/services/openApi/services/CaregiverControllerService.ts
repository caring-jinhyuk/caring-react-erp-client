...
export class CaregiverControllerService {
	 ...
	 * @throws ApiError
	 */
	public static getCaregiverUsingGet(phone: string): CancelablePromise<Caregiver> {
	 ...
	 * @throws ApiError
	 */
	public static saveCaregiverUsingPost(caregiver: Caregiver): CancelablePromise<Caregiver | any> {
		return __request(OpenAPI, {
			method: 'POST',
			url: '/caregiver',
			body: caregiver,
	 ...
	 * @throws ApiError
	 */
	public static deleteCaregiverUsingDelete(id: number): CancelablePromise<any> {
		return __request(OpenAPI, {
			method: 'DELETE',
			url: '/caregiver',
			query: {
	 ...
	 * @throws ApiError
	 */
	public static getCityCountUsingGet1(city: string): CancelablePromise<number> {
		return __request(OpenAPI, {
			method: 'GET',
	 ...
	 * @throws ApiError
	 */
	public static getCaregiverIdUsingGet(id: number): CancelablePromise<Caregiver> {
		return __request(OpenAPI, {
			method: 'GET',
			url: '/caregiver/id',
			query: {
	 ...
	 * @throws ApiError
	 */
	public static updateCaregiverUsingPut(id: number): CancelablePromise<Caregiver | any> {
		return __request(OpenAPI, {
			method: 'PUT',
	 ...
	 * @throws ApiError
	 */
	public static getWardCountUsingGet(city: string, ward: string): CancelablePromise<number> {
		return __request(OpenAPI, {
			method: 'GET',
